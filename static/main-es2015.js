...
let UploadService = class UploadService {
    ...
    sendFile(fileName, file) {
        return this.http.put(this.getURl(fileName), file, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](),
            responseType: "blob"
        });
    }
};
...
module.exports = __webpack_require__(/*! /home/shibin/experiment/camscan/watermark-python/pythonaw-django/watermark-ui/src/main.ts */"./src/main.ts");
